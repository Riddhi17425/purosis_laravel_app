...
<tr>
    <td style="padding: 40px;">
        ...
        <p style="margin: 0 0 40px 0; font-family: Arial, sans-serif; font-size: 16px; color: #777777;">Thank you for your order. Your purchase order has been placed successfully.</p>
        ...
        {{-- <h3 style="margin-top: 25px; color: #111827;">Distributor Details</h3>
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
            style="border-collapse: collapse;">
            <tr>
