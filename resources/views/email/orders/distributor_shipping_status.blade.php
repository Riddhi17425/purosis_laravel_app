...
<tr>
    <td style="padding: 40px;">
        ...
        <p style="margin: 0 0 40px 0; font-family: Arial, sans-serif; font-size: 16px; color: #777777;">Your shipping status has been updated to {{ $order->shipping_status ?? '-' }}. Please find the updated order details below.</p>
