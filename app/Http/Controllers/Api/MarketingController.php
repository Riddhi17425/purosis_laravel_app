...
class MarketingController extends Controller
{
    ...
    public function addUpdateVideo(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            ...
            'media_file' => 'required|mimes:jpeg,png,jpg,webp,mp4,avi,mov,mkv|max:4096',
            'thumbnail_image' => 'required|mimes:jpeg,png,jpg,webp|max:2048',
            'month' => 'nullable',
            'year' => 'nullable',
            ...
            'title.required' => 'The title field is required.',
            'category.required' => 'Please select a category.',
            'media_file.required' => 'Please upload a Image file.',
            'media_file.file' => 'The uploaded file must be a valid file.',
